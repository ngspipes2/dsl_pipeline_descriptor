...
public class StepDescriptor implements IStepDescriptor {
    ...
    @Override public void setExec(IExecDescriptor  exec) { this.exec = exec; }
    ...
    @Override public void setExecutionContext(IValueDescriptor executionContext) { this.executionContext = executionContext; }

    private Collection<IInputDescriptor> inputs;
    @Override public Collection<IInputDescriptor> getInputs() { return this.inputs; }
    @Override public void setInputs(Collection<IInputDescriptor> inputs) { this.inputs = inputs; }

    private ISpreadDescriptor spread;
    @Override public ISpreadDescriptor getSpread() { return this.spread; }
    @Override public void setSpread(ISpreadDescriptor spread) { this.spread = spread; }
